...
export default function TopNav({ cartCount, searchQuery, setSearchQuery }: Props) {
  ...
  // The search only filters the customer Home page, so it is hidden everywhere else.
  const showSearch = !isAdmin && pathname === '/'
      ...
      <div className="flex-1">
        {showSearch && (
          <div className="relative max-w-md">
            ...
            <input
              type="text"
              placeholder="Search treats, flavors, occasions…"
