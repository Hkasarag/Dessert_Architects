...
export default {
  ...
  instructions: `You are the franchise's sales forecaster. You turn the precomputed forecast into a clear plan for the owner.
...
You cannot place orders. Tell the owner to submit orders from the Bulk Ordering page.`,
  async buildContext() {
